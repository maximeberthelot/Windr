...
class DraggableView: UIView {
    ...
    var image: UIImage!
    var imgCheckView: UIImageView!
    var imageGrad: UIImage!
    var imageGradView: UIImageView!
    ...
    override init(frame: CGRect) {
        ...
        //-----o set label title
        title = UILabel(frame: CGRectMake(20, 265, self.frame.size.width, 100))
        title.font = UIFont(name: "Avenir-Black", size: 13)
